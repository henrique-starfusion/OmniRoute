...
import { CODEBUDDY_CN_USER_AGENT } from "@omniroute/open-sse/config/codebuddyCn.ts";
...
//
// CODEBUDDY_CN_USER_AGENT lives in open-sse/config/codebuddyCn.ts (single source of
// truth, #12702) and is re-exported here for existing importers.
